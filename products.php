		...
		<div class="container">
			...
			<div class="col-md-8 products-right">
				...
				<?php		
					include("Include/dbconnect.php");
					$cat=$_REQUEST['cat'];	
					$qry="select * FROM `add_products` where `s_category` ='$cat'";
					...
					<div class="col-md-4 products-right-grids-bottom-grid">
						<div class="new-collections-grid1 products-right-grid1 animated wow slideInUp"
							...
							<div class="simpleCart_shelfItem products-right-grid1-add-cart">
								<p><i><s><?php echo "₹"; echo $row['o_price']; ?></s></i>
									<span class="item_price"><?php echo "₹"; echo $row['p_price']; ?></span>
									<a class="item_add" href="cart.php?id=<?php echo $row[0];?>">add to cart</a>
								</p>
